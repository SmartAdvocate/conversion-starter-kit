/* ########################################################
This script populates UDF Other  with all columns from user_tab9_data
*/
...
LEFT JOIN [sma_MST_UDFDefinition] def on def.[udfnRelatedPK] = cas.casnOrgCaseTypeID 
																  ...
																  and def.[udfsScreenName] = 'Other9'  and udfstype = nuf.UDFType
