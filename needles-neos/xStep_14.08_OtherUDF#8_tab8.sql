/* ########################################################
This script populates UDF Other  with all columns from user_tab8_data
*/
...
----select *
FROM  [NeosBillEasterly]..user_tab8_data td
...
LEFT JOIN [sma_MST_UDFDefinition] def on def.[udfnRelatedPK] = cas.casnOrgCaseTypeID 
																  ...
																  and def.[udfsScreenName] = 'Other8'  and udfstype = nuf.UDFType
