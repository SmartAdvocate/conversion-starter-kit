/* ########################################################
This script populates UDF Other  with all columns from user_tab6_data
*/
...
LEFT JOIN [sma_MST_UDFDefinition] def on def.[udfnRelatedPK] = cas.casnOrgCaseTypeID 
																  ...
																  and def.[udfsScreenName] = 'Other6'  and udfstype = nuf.UDFType
 ORDER BY ucf.field_title
GO	 

 select *
 from sma_MST_UDFDefinition
 where udfsType ='Contact'    and udfsScreenName = 'Other6'
