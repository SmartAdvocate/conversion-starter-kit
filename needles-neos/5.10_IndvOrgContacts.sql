...
INSERT INTO IndvOrgContacts_Indexed ( CID,CTG,AID,UNQCID,Name,SAGA, saga_ref )
SELECT 
    IOC.CID				as CID,
    IOC.CTG				as CTG,	
...
FROM
(
	SELECT cinnContactID as CID, cinnContactCtg as CTG, cinsFirstName + ' ' + cinsLastName as Name, saga as SAGA, saga_ref as SAGA_REF FROM [sma_MST_IndvContacts]  
	UNION
	SELECT connContactID as CID, connContactCtg as CTG, consName as Name, saga as SAGA, saga_ref as SAGA_REF FROM [sma_MST_OrgContacts]  
) IOC
