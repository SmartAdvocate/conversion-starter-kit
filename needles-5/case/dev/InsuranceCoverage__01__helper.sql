...
steps:
	...
	- Create insurance types from [BenAbbot_Needles].[insurance].[policy_type] > [sma_MST_InsuranceType]
usage_instructions:
	- 
dependencies:
	- 
...
--select distinct i.policy_type from [BenAbbot_Needles]..insurance i