/* ########################################################
This script populates UDF Other10 with all columns from user_tab_data
*/
...
insert into [sma_MST_UDFDefinition]
	...
	join sma_trn_Cases cas
		on cas.source_id = CONVERT(VARCHAR(50), utd.casesid)
