/* ########################################################
This script populates UDF Other3 with all columns from user_tab_data
*/
...
insert into [sma_MST_UDFDefinition]
	(
		...
		null										 as [udfsNewValues],  -- can fill in if you add picklist logic
		DENSE_RANK() over (order by ucf.field_title) as udfnSortOrder
	from BenAbbot_Needles..user_tab3_data utd
	join BenAbbot_Needles..user_tab3_list utl
