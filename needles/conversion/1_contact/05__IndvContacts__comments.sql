/*---
description: Update Individual Contact comments

steps: >
  - "Age" from [party_Indexed] and [names]
  - "Age at DOI" from [party_Indexed] and [cases]
  - "Deceased" from [party_Indexed] and [names]
  - "Date of Death" from [party_Indexed] and [names]
  - "Incapacitated" from [party_Indexed] and [names]
  - "Incapacity" from [party_Indexed] and [names]
  - "Responsible for another party" from [party_Indexed] and [names]

dependencies:
  - initialize\02__create__party_indexed.sql
