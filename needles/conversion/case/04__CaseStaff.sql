/* ###################################################################################
description: Inserts Case Staff records from needles staff_1 through staff_10
steps:
...
-- for testing
		...
		--    JOIN [sma_MST_Users] U on (U.source_id = C.staff_3)
...
/* ------------------------------------------------------------------------------
Use the blocks below to apply custom case staff mapping
*/ ------------------------------------------------------------------------------
