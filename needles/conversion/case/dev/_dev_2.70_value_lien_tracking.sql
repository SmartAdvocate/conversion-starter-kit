...
/*
alter table [Needles].[dbo].[sma_TRN_Lienors] disable trigger all
delete from [Needles].[dbo].[sma_TRN_Lienors] 
DBCC CHECKIDENT ('[Needles].[dbo].[sma_TRN_Lienors]', RESEED, 0);
alter table [Needles].[dbo].[sma_TRN_Lienors] enable trigger all

alter table [Needles].[dbo].[sma_TRN_LienDetails] disable trigger all
delete from [Needles].[dbo].[sma_TRN_LienDetails] 
DBCC CHECKIDENT ('[Needles].[dbo].[sma_TRN_LienDetails]', RESEED, 0);
alter table [Needles].[dbo].[sma_TRN_LienDetails] enable trigger all
...
select count(*) from [Needles].[dbo].[sma_TRN_Lienors]
