...
FROM [Needles].[dbo].[user_case_matter] M 
inner join [Needles].[dbo].[user_case_fields] F on F.field_title=M.field_title
...
from (
	...
	from [Needles]..user_case_data ud
...
insert into [sma_MST_UDFDefinition]
	...
	join [Needles].[dbo].[user_case_matter] m
	...
	--JOIN [Needles].[dbo].[user_Case_Fields] ucf on m.ref_num = ucf.field_num
	...
	--		table_name,
	--		column_name
	--	from [Needles].[dbo].[document_merge_params]
...
--select * From [Needles]..[user_case_matter]
