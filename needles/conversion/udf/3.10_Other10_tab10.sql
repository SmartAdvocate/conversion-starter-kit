...
-- Dynamically get all columns from [Needles]..user_tab10_data for unpivoting
...
FROM ( 
    ...
    FROM [Needles]..user_tab10_data ud
    JOIN [Needles]..cases_Indexed c ON c.casenum = ud.case_id
...
BEGIN
	INSERT INTO [sma_MST_UDFDefinition]
	   ...
	   ,[udfnSortOrder]
		...
		JOIN [Needles].[dbo].[user_tab10_matter] M
